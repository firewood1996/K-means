...
data1=unpickle("E://机器学习//k-means//cifar-10-python//cifar-10-batches-py//data_batch_2")
data1.keys()
...
predict_labels=kmeans(kdata,10)
...
DBI2=compute_DB_index(kdata,predict_labels,10)
